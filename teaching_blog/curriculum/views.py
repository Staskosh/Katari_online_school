...
class StandardListView(PermissionRequiredMixin, ListView):
    permission_required = 'curriculum.view_standard'
    context_object_name = 'standards'
    model = Standard
    template_name = 'curriculum/standard_list_view.html'

class SubjectListView(PermissionRequiredMixin, DetailView):
...
class LessonListView(PermissionRequiredMixin, DetailView):
    permission_required = 'curriculum.view_lesson'
    context_object_name = 'subjects'
    model = Subject
    template_name = 'curriculum/lesson_list_view.html'

class LessonDetailView(PermissionRequiredMixin, DetailView, FormView):
    permission_required = 'curriculum.view_lesson'
